  ...
  <div class="modal-dialog" role="document">
	...
	<div class="input-group mb-3">
	  ...
	  <div class="input-group-append">
	    <button class="btn btn-success" type="button" onclick="buscarUsuarioTest();">Buscar</button>
	  </div>
	</div>
...
function buscarUsuarioTest() {
    	
	var nomeBusca = document.getElementById('nomeBusca').value;
		/*Sem ajax tá dando valor null. Não sei se está certo esse código*/    	
    document.getElementById("formUser").method = 'get';
    document.getElementById("action").value = 'buscarUser';
...
function buscarUsuario() {
    ...
    if (nomeBusca != null && nomeBusca != '' && nomeBusca.trim() != ''){ /*Validando que tem que ter valor pra buscar no banco*/
	 ...
	 $.ajax({
	     ...
	     method: "get",
	     url : urlAction,
	     data : "nomeBusca=" + nomeBusca + '&action=buscarUserAjax',
